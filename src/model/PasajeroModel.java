...
public class PasajeroModel implements PasajeroCRUDRepository {
    ...
    public void agregarPasajero(Pasajero pasajero) {
        ...
        try {
            //2. Sentencia SQL
            String sql = "INSERT INTO pasajero (id,name,apellido,documentoIdentidad) VALUES(?,?,?,?);";
    ...
    public Pasajero buscarPorId(String id) {
        ...
        try {
            ...
            while (objResult.next()) {
                ...
                objPasajero.setName(objResult.getString("name"));
...
//1. Abro la conexion
        ...
        try {
            //2. Sentencia sql
            String sql = "UPDATE pasajero SET name = ? , apellido = ? , documentoIdentidad = ?  WHERE id = ? ;";
